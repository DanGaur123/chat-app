...
import { Box, Dialog, Slide, DialogContent, DialogTitle, DialogContentText, DialogActions, Stack, Typography, IconButton, Avatar, Divider, Button } from "@mui/material"
import { useTheme } from "@mui/material/styles"
import { X, Phone, Trash, Prohibit, VideoCamera, CaretRight, Star, Bell } from "phosphor-react"
...
const BlockDiaglog = ({ open, handleClose }) => {
  return (
    <Dialog
      open={open}
...
const DeleteDiaglog = ({ open, handleClose }) => {
  return (
    <Dialog
      open={open}
      TransitionComponent={Transition}
...
const Contact = () => {
  ...
  return (
    <Box sx={{ width: 320, height: "100vh" }}>
        ...
        <Stack sx={{ height: "100%", position: "relative", flexGrow: 1, overflowY: "scroll" }} p={3} spacing={3}>
          <Stack direction={"row"} alignItems={"center"} spacing={2}>
            ...
            <Stack spacing={0.5}>
              ...
              <Typography variant='body2' fontWeight={500}>+91-524 2123 498</Typography>
            </Stack>
          </Stack>
          ...
          <Stack spacing={0.5}>
            ...
            <Typography variant='body2'>Hello there i am using this app</Typography>
          </Stack>
          <Divider />
          ...
          <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
            <Stack direction={"row"} alignItems={"center"} spacing={2}>
              <Star size={21} />
              <Typography variant='subtitle2'>Star Messages</Typography>
            </Stack>
          ...
          <Stack direction={"row"} spacing={2} alignItems={"center"}>
            ...
            <Stack spacing={0.5}>
              <Typography variant='article'>Group's Name</Typography>
              <Typography variant='caption'>Danish,Ankit,Karan,You</Typography>
            </Stack>
          </Stack>
          <Stack direction={"row"} alignItems={"center"} spacing={2}>
            <Button onClick={() => (
      ...
      <BlockDiaglog open={openBlock} handleClose={handleCloseBlock} />
      <DeleteDiaglog open={openDelete} handleClose={handleCloseDelete} />
    </Box>
  )
}
